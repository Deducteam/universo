...
let add_suffix : file -> string -> string = fun file suffix ->
...
let from_string : file -> step -> string = fun file step ->
...
let md_of_file : file -> Basic.mident = fun file ->
...
let signature_of_file : ?sg:Signature.t -> file -> Signature.t = fun ?sg file ->
